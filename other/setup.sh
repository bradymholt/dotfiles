...
# VS Code
ln -siv $SCRIPT_PATH/vscode-settings.json "${HOME}/Library/Application Support/Code/User/settings.json"
...
ln -siv $SCRIPT_PATH/com.hegenberg.BetterSnapTool.plist "${HOME}/Library/Preferences/com.hegenberg.BetterSnapTool.plist"