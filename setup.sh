...
find $DOTFILES_PATH -maxdepth 1 -mindepth 1 \( ! -iname $CURRENT_SCRIPT_NAME ! -iname ".git" ! -iname ".gitignore" ! -iname "README.md" \) -exec ln -sv${LINK_TARGET_EXISTS_HANDLING} {} $HOME ';'
